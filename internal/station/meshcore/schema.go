...
func stationSchema() []schema.Attr {
	...
	return append(out,
		...
		schema.Attr{Name: "multi_acks", Type: schema.Int,
			Doc: "MeshCore extra acknowledgement preference byte, 0..255"},
		...
		schema.Attr{Name: "telemetry_mode", Type: schema.Int,
			Doc: "three packed two-bit MeshCore telemetry permissions, 0..63"},
		...
		schema.Attr{Name: "rx_delay_milli", Type: schema.Int,
			Doc: "MeshCore companion receive-delay factor in fixed-point thousandths"},
		schema.Attr{Name: "airtime_factor_milli", Type: schema.Int,
			Doc: "MeshCore companion airtime factor in fixed-point thousandths; default 1000"},
