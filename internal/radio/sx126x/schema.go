...
func Schema() []schema.Attr {
	return []schema.Attr{
		...
		{Name: "gpiochip", Type: schema.String,
			Doc: "the GPIO character device (empty takes gpiochip0)"},
		{Name: "reset_pin", Type: schema.Int,
			Doc: "NRESET line, BCM numbering"},
		{Name: "busy_pin", Type: schema.Int,
			Doc: "BUSY line, BCM numbering"},
		{Name: "dio1_pin", Type: schema.Int,
			Doc: "DIO1 interrupt line, BCM numbering"},
		{Name: "enable_pins", Type: schema.Ints,
