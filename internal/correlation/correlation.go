// Package correlation issues the identifiers that make frame stories
// traceable across the daemon. Every frame heard gets one; decisions,
// derived emissions, observer publications and every log line that
// concerns it carry the same correlation.
//
...
// file finds the whole causal story, and structured fields such as
// duplicate_of link related correlations.
package correlation
...
// IsZero reports whether no correlation was assigned. Production
...
// WithContext carries a frame correlation through an API whose
